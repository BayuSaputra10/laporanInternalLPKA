...
import type { VehicleFuelReport } from "@/lib/types"

interface LatestVehicleFuelReportsProps {
  reports: VehicleFuelReport[]
}

export default function LatestVehicleFuelReports({ reports }: LatestVehicleFuelReportsProps) {
  return (
