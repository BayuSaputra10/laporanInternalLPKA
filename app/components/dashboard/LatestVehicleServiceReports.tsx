...
import type { VehicleServiceReport } from "@/lib/types"

interface LatestVehicleServiceReportsProps {
  reports: VehicleServiceReport[]
}

export default function LatestVehicleServiceReports({ reports }: LatestVehicleServiceReportsProps) {
  return (
