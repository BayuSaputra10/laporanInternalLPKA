...
export default function GensetFuelDetailClient({ data }: any) {
  ...
  const exportPDF = async () => {
    ...
    pdf.save(`genset-fuel-report-${data.id}.pdf`)
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        >
          <KopSurat title="Laporan Pengisian Solar Genset" />
