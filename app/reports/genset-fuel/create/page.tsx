...
export default function CreateGensetFuelReport() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch('/api/reports/genset-fuel', { method: 'POST', body: formData })
      const data = await res.json()
      if (res.ok && data.success) {
        toast.success('Laporan pengisian solar genset berhasil dibuat!')
        router.push('/reports/genset-fuel')
      } else {
        toast.error(data.message || 'Gagal membuat laporan pengisian solar genset')
      }
    } catch {
