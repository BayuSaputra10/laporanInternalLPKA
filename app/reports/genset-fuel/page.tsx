...
function GensetFuelPage() {
  ...
  const basePath = '/reports/genset-fuel'
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await fetch(
          `/api/reports/genset-fuel?page=${page}&limit=${limit}&sortBy=${sortBy}&sortDir=${sortDir}`
        )
        ...
        {data.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-gray-500 mb-2">
              Belum ada laporan solar genset
            </h3>
            <Link
                        ...
                        <div className="flex gap-2 justify-end">
                          ...
                          <button
                            onClick={async () => {
                              ...
                              try {
                                await deleteReport(r.id, 'genset-fuel')
