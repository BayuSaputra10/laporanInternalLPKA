...
import { Truck, Zap, FileText, Plus, ArrowRight, Calendar, Users, Table, BarChart3 } from "lucide-react"
    ...
    <>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-20">
        <div className="group bg-gradient-to-br from-lpka-green/10 via-white/50 to-lpka-green/5 border-4 border-lpka-green/20 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 backdrop-blur-sm text-center">
          ...
          <h3 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 leading-tight">
            Total Laporan Genset
          </h3>
          <div className="text-5xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-lpka-green to-[#10b981] bg-clip-text text-transparent drop-shadow-2xl">
        ...
        <div className="group bg-gradient-to-br from-lpka-primary/10 via-white/50 to-lpka-primary/5 border-4 border-lpka-primary/20 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 backdrop-blur-sm text-center">
          ...
          <div className="text-5xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-lpka-primary to-[#3b82f6] bg-clip-text text-transparent drop-shadow-2xl">
      ...
      {/* VEHICLE REPORTS - SIMILAR ENHANCEMENTS */}
      <section>
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-4">
          <div className="flex items-center gap-4">
