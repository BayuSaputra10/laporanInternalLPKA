...
export async function GET(req: Request) {
  try {
    ...
    const validSortFields = ['id', 'tanggal', 'createdAt']
    ...
    const orderByMap: Record<string, Prisma.GensetServiceReportOrderByWithRelationInput> = {
      id: { id: sortDir },
    ...
    console.error('GET Genset Service Reports Error:', error)
...
export async function POST(req: Request) {
  try {
    ...
    console.log("GENSET SERVICE PAYLOAD:", {
      tanggal,
      catatan
    })
    ...
    const report = await prisma.gensetServiceReport.create({
      data: {
    ...
    console.log("CREATED GENSET SERVICE REPORT:", report)
    ...
    console.error("GENSET SERVICE API ERROR FULL:", error)
    return NextResponse.json(
      {
        success: false,
...
export async function DELETE(req: Request) {
  try {
    ...
    console.error('DELETE Genset Service Report Error:', error)
