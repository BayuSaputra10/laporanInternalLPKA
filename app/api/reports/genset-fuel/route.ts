...
export async function GET(req: Request) {
  try {
    ...
    const validSortFields = ['id', 'tanggal', 'tambahSolar', 'createdAt']
    ...
    const orderByMap: Record<string, Prisma.GensetFuelReportOrderByWithRelationInput> = {
      id: { id: sortDir },
    ...
    console.error('GET Genset Fuel Reports Error:', error)
...
export async function POST(req: Request) {
  try {
    ...
    console.log("GENSET FUEL PAYLOAD:", {
      tambahSolar,
      tanggal
    })
    ...
    const report = await prisma.gensetFuelReport.create({
      data: {
        tambahSolar,
    ...
    console.log("CREATED GENSET FUEL REPORT:", report)
    ...
    console.error("GENSET FUEL API ERROR FULL:", error)
    return NextResponse.json(
      {
        success: false,
...
export async function DELETE(req: Request) {
  try {
    ...
    console.error('DELETE Genset Fuel Report Error:', error)
